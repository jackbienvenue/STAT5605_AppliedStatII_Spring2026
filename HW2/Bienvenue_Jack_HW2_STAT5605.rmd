...
To find $S_{XX}$, we can use the relation that $S_{XX} = \frac{\hat{\sigma}^2}{\text{SE}(\hat{\beta}_1)^2}$. We know that $\hat{\sigma}^2 = 3.7056$ from our work in Part (a) and that $\text{SE}(\hat{\beta}_1) = 0.2192$ from the outputs provided by the question. So, $S_{XX} = \frac{3.7056}{0.2192} = 16.905$.
...
Finally, we can acquire $CV_{X}$ as $CV_X = \frac{ \sqrt{\frac{16.905}{100}} }{ |0.0228| } \approx 18.0$.
\end{bluebox}
